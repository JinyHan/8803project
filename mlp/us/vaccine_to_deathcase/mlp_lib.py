...
class MLP:
    ...
    def predict(self, vaccine_features, predict_content, file_name_element):
    # split test and train
        feature_names= ['Daily Count People Receiving Dose 1', 'People Receiving 1 or More Doses Cumulative']
        X_train, X_test, y_train, y_test = train_test_split(vaccine_features, predict_content, test_size=0.3, random_state=42)
        # standard scaler
