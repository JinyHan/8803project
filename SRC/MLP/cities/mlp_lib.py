...
class MLP:
    ...
    # split test and train
        feature_names=['Series_Complete_Yes', 'Series_Complete_12Plus', 'Series_Complete_18Plus', 'Series_Complete_65Plus']
        ...
        class MLPregression(nn.Module):
            def __init__(self):
                ...
                self.hidden1 = nn.Linear(in_features=4, out_features=100, bias=True)  # 2*100 2个属性特征
